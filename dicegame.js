...
const Check6ix = (x,isPlayer1)=>{
    ...
    if (totalDiceRol === 6 || sixComboPlayer1 ==3 || sixComboPlayer2 === 3){
        ...
        if (totalDiceRol == 4 || sixComboPlayer1 === 2 || sixComboPlayer2 === 2){
                if (sixComboPlayer1 == 2){
                    thewinner.innerText = "Player One won with "+(playerOneTotalScore)+" points!!"
                }
                else if (sixComboPlayer2 === 2){
                    thewinner.innerText = "Player Two won with "+(playerTwoTotalScore)+" points!!"
                }
...
const replay = document.getElementById("PlayAgains")
